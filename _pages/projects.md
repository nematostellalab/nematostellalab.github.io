...
The Leach Lab studies behavior, circadian biology, and host–environment interactions in the starlet sea anemone, *Nematostella vectensis*. We combine low-cost technology, experimental biology, and behavior research to explore how organisms interact with their environment across time.
...
<div class="project-card">
  ...
  <ul>
    <li>Tentacle extension</li>
    <li>Body length changes</li>
    <li>Whole-organism movement</li>
  </ul>
</div>
